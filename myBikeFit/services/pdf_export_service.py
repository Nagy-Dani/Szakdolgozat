...
class PDFReportGenerator(FPDF):
    ...
    def _draw_scores(self, scores: FitScore) -> None:
        ...
        for i, (name, score) in enumerate(components):
            if score >= 90: color = (34, 197, 94)
            elif score >= 75: color = (132, 204, 22)
            elif score >= 55: color = (234, 179, 8)
            ...
            self.cell(4, 10, "", new_x="RIGHT", new_y="TOP")
